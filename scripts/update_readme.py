...
def add_exercise_to_readme(category, exercise_number, exercise_name, difficulty):
    ...
    table_header = "| Exercise Number | Exercise Name | Difficulty |\n"
    table_separator = "|-----------------|---------------|------------|\n"
    ...
    category_index = readme_content.index(category_header) + 3  # Skip header and table header
    ...
    table_start_index = readme_content.index(category_header) + 3
...
if __name__ == "__main__":
    ...
    if category not in VALID_CATEGORIES:
        ...
        add_exercise_to_readme(category, exercise_number, exercise_name, difficulty)
